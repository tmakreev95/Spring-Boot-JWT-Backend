...
<head>
    ...
    <title>Resent Verification Email</title>
                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="text-center pb25" style="color:#c1cddc; font-family:'Muli',
                                        ...
                                        We have RESENT to ${email} a conformation code, so you can complete your
                                        ...
                                        <table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                            <tr>
                                                <td class="pink-button text-button">
                                                    <#assign url="http://localhost:8080/verifyToken/${verificationToken}">
