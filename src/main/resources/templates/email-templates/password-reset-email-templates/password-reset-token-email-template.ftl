                            ...
                            <table width="100%" border="0" cellspacing="0" cellpadding="0">
                                ...
                                <tr>
                                    <td class="text-center pb25" style="color:#c1cddc; font-family:'Muli',
                                        ...
                                        We have SENT to ${email} a password reset token, so you can complete your
                                        password reset and start using your account with your new password.
                                        Proceed to the link for completing the password reset process!</td>
                                </tr>
                                <!-- Button -->
                                <tr>
                                    <td align="center">
                                        <table class="center" border="0" cellspacing="0" cellpadding="0" style="text-align:center;">
                                            <tr>
                                                <td class="pink-button text-button">
                                                    <#assign url="http://localhost:4200/password-reset/verify-token;token=${passwordResetToken}">
